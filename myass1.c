...
/* void find_room_table(/\*int room_type, int room_num,*\/ double xsize, double ysize); */
...
/* void */
/* find_room_table(/\*int room_type,int room_num,*\/ double xsize, double ysize) { */
